...
class MotorSafeDriverCloud:
    ...
    def processar_datalake(self, df):
        ...
        # Ordenação Cronológica Obrigatória para evitar Data Leakage
        ...
        # shuffle=False garante que o Teste seja ESTRITAMENTE o futuro em relação ao Treino
        ...
        # --- 4. EXPORTAÇÃO DO MANIFESTO DE AUDITORIA ---
        manifesto = {
        ...
        self._notificar_discord(assertividade, r2_teste, r2_treino, degradacao, status_overfitting, top_features, v_bruto, len(fato), time.time() - t_ini)
    ...
    def _notificar_discord(self, taxa, r2_te, r2_tr, deg, status_over, top_feat, bruto, fato_vol, tempo):
        if not self.webhook: return
        
        cor_embed = 3066993 if "SAUDÁVEL" in status_over else 15158332 # Azul se ok, Vermelho se Overfitting
