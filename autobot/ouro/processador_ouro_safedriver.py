...
class ArquitetoSafeDriverOuro:
    ...
    def _limpar_tabela_toda(self, df):
        ...
        return df.with_columns([
            ...
            # Mata qualquer coisa que nao seja letra, numero, espaco ou underscore
            .str.replace_all(r"[^A-Z0-9\s_]", " ")
            # Consolida espacos duplos em um so
            .str.replace_all(r"\s+", " ")
    ...
    def construir_abt_final(self):
        ...
        # 1. CARREGAMENTO E LIMPEZA DA MALHA
        ...
        # 2. CARREGAMENTO E LIMPEZA DOS CRIMES
        ...
        # 3. HORA E TURNOS (A prova de falhas)
        ...
        # 4. DOSIMETRIA E CONTEXTO (Com strings ja limpas)
        ...
        # Preenchimento de nulos em colunas numericas
        ...
        # Uma ultima limpeza em todas as colunas de texto geradas ou integradas
        df_final = self._limpar_tabela_toda(df_final)

        # Drop colunas de processamento
        ...
        report = (
            f"Relatorio Ouro - Normalizacao Total Aplicada\n"
            f"============================================\n"
            f"- Registros: {df_final.height}\n"
            f"- Tempo: {duracao}s\n"
            f"--------------------------------------------\n"
            f"DISTRIBUICAO TEMPORAL:\n"
