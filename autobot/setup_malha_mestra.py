...
def build_malha_mestra():
    ...
    # Defesas de Memória para o ambiente do GitHub Actions
    ...
    try:
        ...
        # Estratégia de Micro-Lotes para evitar OutOfMemory
        lote_tamanho = 50000
        ...
        for i in range(0, total_linhas, lote_tamanho):
            ...
            # Passo A: Cruzamento com Polígonos Administrativos
            con.execute("""
            ...
            # Passo B: Cruzamento por Proximidade com Logradouros (ST_DWithin)
        ...
        print("\n🧩 Consolidando e Formatando Textos...")
        ...
        df_final = df_completo.with_columns([
            ...
            # FIX: Conversão hexadecimal nativa para evitar erros de versão da biblioteca h3
