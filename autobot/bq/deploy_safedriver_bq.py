...
def _ler_parquet_r2(self, key):
    ...
    # Correção 1: Sem fill_null(0.0) para não atirar localizações para o mar
...
def _construir_obt_looker(self):
    ...
    Base_Geo_Filtrada AS (
      ...
      FROM Base_Limpa
      -- Correção 2: Cerca Geográfica Estrita: Estado de São Paulo
    ...
    Base_Agregada AS (
      SELECT 
        ...
        -- Correção 3: COUNT(1) no lugar de COUNT(NUM_BO)
        ...
        -- Correção 4: MAX() para não dar conflito no agrupamento
