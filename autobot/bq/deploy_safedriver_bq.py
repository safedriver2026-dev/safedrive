...
class DeploySafeDriverBigQuery:
    ...
    Atualizado: Suporte ao KPI_RISCO_EVOLUCAO (Matched-Set) e Clusters K-Means.
    """
    def __init__(self):
    ...
    def executar_deploy(self):
        ...
        self._notificar_discord(f"🌐 Deploy Finalizado em {duracao}s! Tabela OBT Biênio (2025-2026) disponível no BigQuery com KPI de Evolução Anual e Clusters K-Means.")
